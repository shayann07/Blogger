        ...
        if (cursor.moveToFirst()) {
            do {
                BlogPost post = new BlogPost(
                        ...
                        cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COLUMN_IMAGE_PATH)),
                        cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COLUMN_DATE_TIME))
                );
                blogList.add(post);
